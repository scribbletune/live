      ...
      rules: [
          ...
          use: [
            {
              ...
              options: {
                filterSourceMappingUrl: (url, resourcePath) => {
                  ...
                  if (res !== true) console.log('DEBUG: react-scripts/config/webpack.config.js: url=%o resourcePath=%o res=%o', url, resourcePath, res);
                  return res;
                  // return values:
        ...
        },
        {
          ...
          oneOf: [
            ...
            // Raw loader setup for getting source of .js files. TODO: copy to production, perhaps using Rescript or craco or such.
            // {
            //   test: /^\.\/src\/tracks\/(?!index)[^/]*\.js$/i,
            //   use: 'raw-loader',
            // },
            // Seems to work fine without webpack config.
            // Just use require.context('!!raw-loader!${directory}', ...).
